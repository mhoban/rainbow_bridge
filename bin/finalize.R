...
option_list = list(
  ...
  make_option(c("-a", "--control-action"), action="store", default="remove", type="character", help="Action to perform on taxa found in negative control samples [default: %default]"),
  ...
  make_option(c("-t", "--abundance-threshold"), action="store", default=0.0001, type="double", help="Minimum relative abundance for abundance filtering [default: %default]"),
  make_option(c("-r", "--rarefy"), action="store_true", default=FALSE, type="logical", help="Rarefy read counts to minimum depth"),
  make_option(c("-m", "--rarefaction-method"), action="store", default="perm", type="character", help="Rarefaction method [default: %default]"),
  make_option(c("-u", "--permutations"), action="store", default=100, type="double", help="Number of permutations for permutational rarefaction [default: %default]"),
  make_option(c("-p", "--taxon-priority"), action="store", default="lca", type="character", help="Which method gets priority with differing taxonomies [default: %default]"),
